...
type NsqConfig struct {
	Nsqwrites []string `toml:"nsq_writers"`
}
...
type Config struct {
	...
	SelfMyHost   string `toml:"self_my_host"`
	SelfMyPort   int    `toml:"self_my_port"`
	SelfMyUser   string `toml:"self_my_user"`
	SelfMyPasswd string `toml:"self_my_passwd"`
	SelfMyDb     string `toml:"self_my_db"`
	...
	DumpIgnoreTables []string `toml:dump_ignore_tables`
}
